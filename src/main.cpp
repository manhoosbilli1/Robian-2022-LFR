...
const double KP = 3;             //you should edit this with your experiments....start with same values then increase or decrease as you like
const double KD = 0.5;
double lastError = 0;
const int GOAL = 2500;
const unsigned char MAX_SPEED = 70;

// pid setting with bluetooth vars                        
float Kp = 0;
float Ki = 0;
float Kd = 0;
uint8_t multiP = 1;
...
void loop()
{
  ...
  //   valuesread();
  //   processing();
  //   myPID.SetTunings(Kp, Ki, Kd);   //sets the constants to newly aquired from bluetooth
  // }
